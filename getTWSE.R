...
# ============================================================================================
library(quantmod)
tw2300 <- getTWSE("2330", 2017)
head(tw2300)
tail(tw2300)
barChart(tw2300)
# ===========================================================================================
# use chartTheme, set up.col = 'red'  dn.col = 'green'
# ===========================================================================================
chartSeries(tw2300, theme = chartTheme("white", up.col = "red", dn.col = "green"), 
            name = "TSMC 2330", show.grid = TRUE)
